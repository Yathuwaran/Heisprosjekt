...
\begin{DoxyCompactList}\small\item\em Adds orders to the 4x3 2\+D-\/array called queue in status$\ast$ elevator. The orders are added by setting the value \char`\"{}1\char`\"{} in the array if an order button is pressed. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Goes through the 4x3 2\+D-\/array and checks if every value is 0. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Goes through the 4x3 2\+D-\/array and removes every order on the current floor. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Adds orders to the 4x3 2\+D-\/array called queue in status$\ast$ elevator. The orders are added by setting the value \char`\"{}1\char`\"{} in the array if an order button is pressed. 


\begin{DoxyParams}[1]{Parameters}
\mbox{\tt out}  & {\em status$\ast$} & elevator Struct for elevator status. \\
\hline
\end{DoxyParams}
...
Goes through the 4x3 2\+D-\/array and checks if every value is 0. 
...
Goes through the 4x3 2\+D-\/array and removes every order on the current floor. 
